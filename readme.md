...
::: cards
[!card title="1. Two-Pointer Approach" text="Use when the input array is sorted and you need to find pairs, triplets, or target sums in linear time." icon="list-ordered"](./patterns/two-pointer.md)

[!card title="2. Sliding Window Pattern" text="Use when dealing with contiguous subarrays or substrings to track running states without nested loops." icon="iterations"](./patterns/sliding-window.md)
:::
